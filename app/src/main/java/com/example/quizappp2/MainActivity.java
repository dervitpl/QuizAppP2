...
import static com.example.quizappp2.databinding.ActivityMainBinding.bind;
import static com.example.quizappp2.databinding.ActivityMainBinding.inflate;
        ...
        database.getReference().child("categories").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    Toast.makeText(MainActivity.this, "category not existing", Toast.LENGTH_SHORT).show();
                }
